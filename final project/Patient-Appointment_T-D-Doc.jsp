...
<head>
    ...
    <title>Patient-Appointment_T-D-Doc</title>
...
<main>
    ...
    <form action="SearchAppointmentDoctorTimeDateServlet" method="post">
        <form action="SearchAppointmentTimeDateServlet" method="post">
            <table class="New-Acc">
                <tr>
