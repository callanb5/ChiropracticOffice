 ...
 * @author Calla
 */
@WebServlet(name = "SearchAppointmentDoctorServlet", urlPatterns = {"/SearchAppointmentDoctorServlet"})
public class SearchAppointmentDoctorServlet extends HttpServlet {
