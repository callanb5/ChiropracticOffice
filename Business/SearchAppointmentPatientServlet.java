 ...
 * @author Calla
 */
@WebServlet(name = "SearchAppointmentPatientServlet", urlPatterns = {"/SearchAppointmentPatientServlet"})
public class SearchAppointmentPatientServlet extends HttpServlet {
